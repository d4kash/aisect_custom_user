...
class GrievanceForm extends StatefulWidget {
  const GrievanceForm({Key? key}) : super(key: key);
...
class _GrievanceFormState extends State<GrievanceForm> {
  ...
  CollectionReference userEnq =
      FirebaseFirestore.instance.collection("Student_complains");

  Future<void> addUserEnq() {
    // Call the user's CollectionReference to add a new user
    return userEnq.doc(uid).set({
      'full_name': _name.text, // John Doe

      'phone_no': _phoneno.text,
      'complains': _question.text,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Scaffold(
            ...
            appBar: AppBarScreen(title: 'Complain Form'),
...
//Creates a text element to add the invoice number
    PdfTextElement element =
        PdfTextElement(text: 'GRIEVANCE FORM DETAILS', font: subHeadingFont);
...
//Creates text elements to add the address and draw it to the page
    ...
    loadAndLaunchPdf(bytes, "AisectGrievance.pdf");
// // Save the document.
