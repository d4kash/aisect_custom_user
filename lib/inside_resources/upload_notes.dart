...
class _UploadNotesState extends State<UploadNotes> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarScreen(title: "Upload Notes "),
...
//! upload to cloud firestore________________________
  Future uploadImageToFirebase() async {
    try {
      ...
      final destination =
          'Notes/${ctrl.selectedbatch.toString()}/${ctrl.selectedSem.toString()}/${ctrl.selected.toString()}/${ctrl.facultySubject.toString()}/$fileName';
