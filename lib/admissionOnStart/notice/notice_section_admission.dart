...
class NoticeAdmission extends StatefulWidget {
  @override
  _NoticeAdmissionState createState() => _NoticeAdmissionState();
}

class _NoticeAdmissionState extends State<NoticeAdmission> {
  var modalData;
