...
class UploadSchedule extends StatefulWidget {
  const UploadSchedule({Key? key}) : super(key: key);

  @override
  _UploadScheduleState createState() => _UploadScheduleState();
}
...
//! upload to cloud firestore________________________
  Future uploadImageToFirebase() async {
    try {
      ...
      final destination =
          'ExamSchedule/${ctrl.selectedbatch.toString()}/${ctrl.selectedSem.toString()}/${ctrl.selected.toString()}/${ctrl.facultySubject.toString()}/$fileName';
