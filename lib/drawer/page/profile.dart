...
class _ProfileState extends State<Profile> {
  ...
  String name = "null";
  Future addSpecificData() async {
    //add data from profile
    try {
                    ...
                    body: FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData && !snapshot.data!.exists) {
                          return Onerror(context, "Profile Does not exist");
                        }
...
//! upload to cloud firestore________________________
  Future uploadImageToFirebase() async {
    try {
      ...
      //     // print(percentage);
      //     // print(progress.toString() + "%uploaded");
      //   });
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    loadedtextBox("$name", "Name"),
                                    SizedBox(
                                      height: Constant.height / 50,
                                    ),
                                    loadedtextBox("$phone", "Phone"),
                                    SizedBox(
                                      height: Constant.height / 50,
                                    ),

                                    loadedtextBox("$roll", "Roll"),
                                    SizedBox(
                                      height: Constant.height / 50,
                                    ),
                                    loadedtextBox("$course", "Course"),
                                    SizedBox(
