...
import 'package:aisect_custom/drawer/data/drawer_items.dart';
import 'package:aisect_custom/drawer/model/drawer_item.dart';
import 'package:aisect_custom/drawer/page/Logout.dart';
import 'package:aisect_custom/drawer/page/about.dart';
import 'package:aisect_custom/drawer/page/help.dart';
...
class NavigationDrawerWidget extends StatelessWidget {
  ...
  void selectItem(BuildContext context, int index) {
    ...
    switch (index) {
      case 0:
        navigateTo(HomePageNav());
        break;
      case 1:
        navigateTo(Profile());
        break;
      case 2:
        navigateTo(NoticeStudent());
        break;
      case 3:
        navigateTo(HelpPage());
        break;
